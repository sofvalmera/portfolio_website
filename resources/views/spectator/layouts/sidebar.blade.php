<aside class="main-sidebar sidebar-dark-primary elevation-4">
				<!-- Brand Logo -->
				<a href="{{route('spectator.dashboard')}}" class="brand-link">
				...
				<div class="sidebar">
					...
					<nav class="mt-2">
						<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
							...
							<li class="nav-item">
								<a href="{{route('spectator.dashboard')}}" class="nav-link">
							...
							<li class="nav-item">
								<a href="{{route('spectatortestimonials.index')}}" class="nav-link">
