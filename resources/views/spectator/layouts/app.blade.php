...
<html lang="en">
	...
	<body class="hold-transition sidebar-mini">
		...
		<div class="wrapper">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
							<h4 class="h4 mb-0"><strong>{{Auth::guard('spectator')->user()->name}}</strong></h4>
							<div class="mb-3">{{Auth::guard('spectator')->user()->email}}</div>
							...
							<div class="dropdown-divider"></div>
							<a href="{{route('spectator.logout')}}" class="dropdown-item text-danger">
			...
			@include('spectator.layouts.sidebar')
