...
<!-- Content Header (Page header) -->
				...
				<section class="content">
					...
					<div class="container-fluid">
						<form action="{{route('services.store')}}" method="get" id="editserviceForm" name="editserviceForm" >
						@csrf
						<div class="card">
							<div class="card-body">								
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="servicename" id="servicename" class="form-control" placeholder="Service Name" value="{{$service->servicename}}">	
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="mb-3">
											<label for="icon">HTML Icon</label>
											<input type="text" name="icon" id="icon" class="form-control" placeholder="HTML Icon" value="{{$service->icon}}">	
										</div>
									</div>
                                    ...
                                    <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="description" id="description" cols="30" rows="10" class="summernote" placeholder="Description">{{$service->description}}</textarea>
                                                </div>
                                            </div>                                            
