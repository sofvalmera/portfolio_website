...
<head>
    ...
    <style>
        ...
        .btn-primary:hover {
            background-color: #c2092c !important;
            border-color: #c2092c !important;
        }
        ...
        /* Change the color of "I forgot my password" link */
        .forgot-password-link {
            color: #EF233C !important;
        }

        /* Change the border color of input fields of type color */
        input[type=color]::-webkit-color-swatch-wrapper {
            border-color: #000000 !important;
        }

        /* Set the color of the input type color to black */
        input[type=color] {
...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <p class="mb-1 mt-3">
                <a href="forgot-password.html" class="forgot-password-link">I forgot my password</a>
            </p>
        </div>
        <!-- /.card-body -->
    </div>
