...
class SpectatorTestimonialController extends Controller
{
    //
    public function index(Request $request){
        ...
        return view('spectator.testimonial.list',compact('testimonials'));

        

    }
     public function create(){
        return view('spectator.testimonial.create');
     ...
     public function edit($testimonialId, Request $request){
        ...
        if(empty($testimonial)){
            return redirect()->route('spectatortestimonials.index');
        }
        return view('spectator.testimonial.edit',compact('testimonial'));
