...
class SpectatorProfileController extends Controller
{
    //
    public function index(Request $request){
        ...
        return view('spectator.profile.list',compact('profiles'));

    }
     public function create(){
        return view('spectator.profile.create');
     ...
     public function edit($profileId, Request $request){
        ...
        return view('spectator.profile.edit',compact('profile'));
